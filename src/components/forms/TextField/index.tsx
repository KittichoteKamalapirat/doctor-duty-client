...
const useClassNames = (
  ...
  const commonInputClass = `mt-2 h-14 w-[100%] rounded-lg border auto bg-ice px-4  ${disabledStyles} ${inputSpinButtonsClass}  w-full appearance-none focus:outline-none`;
